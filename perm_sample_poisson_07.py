...
def permute_search_pois(df, block, formula, Y, N, I, T, burnin, interval, t, P_t, b, block_size, original_block, X_missing, num_X_missing):
    ...
    if block_size > 1:
        ...
        if t == 0:
            ...
            P_t, new_y = poisson_permute(A, b, np.array(block_df[y1]), P_t, T, m, Y)
